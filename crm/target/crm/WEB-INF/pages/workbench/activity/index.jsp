...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveCreateActivityBtn").click(function () {
			...
			var contract_state=$.trim($("#create-contract_state").val());
			var invoice_state=$.trim($("#create-invoice_state").val());
			var yewuxinzhi=$.trim($("#create-yewuxinzhi").val());
			var shenjitype=$.trim($("#create-shenjitype").val());
			var shenjiniandu=$.trim($("#create-shenjiniandu").val());
			//表单验证
			if (owner==""){
				alert("所有者不能为空");
				return;
			...
			$.ajax({
				...
				data:{
					...
					yewuxinzhi:yewuxinzhi,
					shenjitype:shenjitype,
					shenjiniandu:shenjiniandu
				},
				type:'post',
				dataType:'json',
		...
		$("#editActivityBtn").click(function(){
			...
			$.ajax({
				...
				success:function (data) {
					...
					$("#edit-contract").val(data.contract_state);
					$("#edit-invoice_state").val(data.invoice_state);
					//显示修改市场活动的模态窗口
		...
		$("#saveEditActivityBtn").click(function () {
			...
			var contract_state=$.trim($("#edit-contract_state").val());
			var invoice_state=$.trim($("#edit-invoice_state").val());
			var yewuxinzhi=$.trim($("#edit-yewuxinzhi").val());
			var shenjitype=$.trim($("#edit-shenjitype").val());
			var shenjiniandu=$.trim($("#edit-shenjiniandu").val());
			//表单验证(作业)
	...
	function queryActivityForPageByCondition(pageNo,pageSize) {
		...
		var contract_state=$("#query-contract_state").val();
		var invoice_state=$("#query-invoice_state").val();
		var yewuxinzhi=$("#query-yewuxinzhi").val();
		var shenjitype=$("#query-shenjitype").val();
		var shenjiniandu=$("#query-shenjiniandu").val();
		//发送请求
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data.activityList,function (index,obj) {
					...
					htmlStr+="<td>"+obj.contract_state+"</td>";
					htmlStr+="<td>"+obj.invoice_state+"</td>";
					htmlStr+="<td>"+obj.yewuxinzhi+"</td>";
					htmlStr+="<td>"+obj.shenjitype+"</td>";
					htmlStr+="<td>"+obj.shenjiniandu+"</td>";
					htmlStr+="</tr>";
				});
	...
	<div class="modal-dialog" role="document" style="width: 85%;">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel1">创建项目</h4>
			</div>
			<div class="modal-body">
				...
				<form class="form-horizontal" role="form" id="activityForm">
					...
					<div class="form-group">
						<label for="create-marketActivityOwner" class="col-sm-2 control-label">负责人<span style="font-size: 15px; color: red;">*</span></label>
					...
					<div class="form-group">
						<label for="create-description" class="col-sm-2 control-label">参与人员及描述</label>
						<div class="col-sm-10" style="width: 81%;">
							<textarea class="form-control" rows="3" id="create-description"></textarea>
						</div>
					</div>
					<div class="form-group">
						<label for="create-contract_state" class="col-sm-2 control-label">合同状态</label>
						<div class="col-sm-10" style="width: 300px;">
							<select class="form-control" id="create-contract_state">
					...
					<div class="form-group">
						<label for="create-invoice_state" class="col-sm-2 control-label">开票状态</label>
						<div class="col-sm-10" style="width: 300px;">
							<select class="form-control" id="create-invoice_state">
					...
					<div class="form-group">
						<label for="create-yewuxinzhi" class="col-sm-2 control-label">业务性质</label>
						<div class="col-sm-10" style="width: 300px;">
							<select class="form-control" id="create-yewuxinzhi">
								<option value="新客户新业务">新客户新业务</option>
								<option value="新客户老业务">新客户老业务</option>
								<option value="老客户老业务">老客户老业务</option>
							</select>
						</div>
					</div>
					<div class="form-group">
						<label for="create-shenjitype" class="col-sm-2 control-label">审计业务类型</label>
						<div class="col-sm-10" style="width: 300px;">
							<select class="form-control" id="create-shenjitype">
								<option value="专项审计">专项审计</option>
								<option value="咨询业务">咨询业务</option>
								<option value="审计其他">审计其他</option>
								<option value="验证资本">验证资本</option>
								<option value="内控审计">内控审计</option>
								<option value="报表审阅">报表审阅</option>
								<option value="资产评估">资产评估</option>
								<option value="咨询评估">咨询评估</option>
							</select>
						</div>
					</div>
					<div class="form-group">
						<label for="create-shenjiniandu" class="col-sm-2 control-label">审计年度</label>
						<div class="col-sm-10" style="width: 300px;">
							<input type="text" class="form-control" id="create-shenjiniandu">
						</div>
					</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						<label for="edit-marketActivityOwner" class="col-sm-2 control-label">负责人<span style="font-size: 15px; color: red;">*</span></label>
						<div class="col-sm-10" style="width: 300px;">
					...
					<div class="form-group">
						<label for="edit-description" class="col-sm-2 control-label">参与人员及描述</label>
						<div class="col-sm-10" style="width: 81%;">
							<textarea class="form-control" rows="3" id="edit-description">市场活动Marketing，是指品牌主办或参与的展览会议与公关市场活动，包括自行主办的各类研讨会、客户交流会、演示会、新产品发布会、体验会、答谢会、年会和出席参加并布展或演讲的展览会、研讨会、行业交流会、颁奖典礼等</textarea>
						</div>
					</div>
					<div class="form-group">
						<label for="edit-contract_state" class="col-sm-2 control-label">合同状态</label>
						<div class="col-sm-10" style="width: 300px;">
							<select class="form-control" id="edit-contract_state">
								<option value="未签合同">未签合同</option>
								<option value="已签合同">已签合同</option>
								<option value="正签合同">正签合同</option>
							</select>
					...
					<div class="form-group">
						<label for="edit-invoice_state" class="col-sm-2 control-label">开票状态</label>
						<div class="col-sm-10" style="width: 300px;">
							<select class="form-control" id="edit-invoice_state">
								<option value="未开票">未开票</option>
								<option value="已开票">已开票</option>
								<option value="待审批">待审批</option>
							</select>
					...
					<div class="form-group">
						<label for="edit-yewuxinzhi" class="col-sm-2 control-label">业务性质</label>
						<div class="col-sm-10" style="width: 300px;">
							<select class="form-control" id="edit-yewuxinzhi">
								<option value="新客户新业务">新客户新业务</option>
								<option value="新客户老业务">新客户老业务</option>
								<option value="老客户老业务">老客户老业务</option>
							</select>
					...
					<div class="form-group">
						<label for="edit-shenjitype" class="col-sm-2 control-label">审计业务类型</label>
						<div class="col-sm-10" style="width: 300px;">
							<select class="form-control" id="edit-shenjitype">
								<option value="专项审计">专项审计</option>
								<option value="咨询业务">咨询业务</option>
								<option value="审计其他">审计其他</option>
								<option value="验证资本">验证资本</option>
					...
					<div class="form-group">
						<label for="edit-shenjiniandu" class="col-sm-2 control-label">审计年度</label>
						<div class="col-sm-10" style="width: 300px;">
							<input type="text" class="form-control" id="edit-shenjiniandu">
						</div>
					</div>
	...
	<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
		...
		<div class="btn-toolbar" role="toolbar" style="height: 80px;">
			<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				...
				<div class="form-group">
					<div class="input-group">
						<div class="input-group-addon">审计年度</div>
						<input class="form-control" type="text" id="query-shenjiniandu">
					</div>
				</div>
