...
<body>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">CRM &nbsp;<span style="font-size: 12px;">&copy;2019&nbsp;山西财智会计师事务所</span></div>
...
<%--                <-- web不能直接访问jsp，故让工作台跳转控制层controller，再打开这个网页   -->--%>
				...
				<li class="liClass"><a href="workbench/customer/index.do" target="workareaFrame"><span class="glyphicon glyphicon-user"></span> 客户管理</a></li>
				<li class="liClass"><a href="workbench/activity/index.do" target="workareaFrame"><span class="glyphicon glyphicon-play-circle"></span> 项目管理</a></li>
				<li class="liClass"><a href="workbench/clue/index.do" target="workareaFrame"><span class="glyphicon glyphicon-search"></span> 潜在客户</a></li>
				<li class="liClass"><a href="#no3" class="collapsed" data-toggle="collapse"><span class="glyphicon glyphicon-user"></span> 合同管理</a>
					<ul id="no3" class="nav nav-pills nav-stacked collapse">
						<li class="liClass"><a href="workbench/invoice/index.do" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 新增合同</a></li>
						<li class="liClass"><a href="chart/clue/index.html" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 合同列表</a></li>
						<li class="liClass"><a href="chart/clue/index.html" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 合同修改</a></li>
					</ul>

				</li>
				<li class="liClass">
					<a href="#no4" class="collapsed" data-toggle="collapse"><span class="glyphicon glyphicon-earphone"></span> 开票管理</a>
					<ul id="no4" class="nav nav-pills nav-stacked collapse">
						<li class="liClass"><a href="workbench/invoice/index.do" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 开票申请</a></li>
						<li class="liClass"><a href="workbench/invoice/query.do" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 开票查看列表</a></li>
					</ul>
				</li>
				<li class="liClass"><a href="transaction/index.html" target="workareaFrame"><span class="glyphicon glyphicon-usd"></span> 交易（商机）</a></li>
				<li class="liClass"><a href="visit/index.html" target="workareaFrame"><span class="glyphicon glyphicon-phone-alt"></span> 绩效管理</a></li>
				<li class="liClass">
				...
				<li class="liClass"><a href="javascript:void(0);" target="workareaFrame"><span class="glyphicon glyphicon-file"></span> 用章管理</a></li>
				<li class="liClass"><a href="javascript:void(0);" target="workareaFrame"><span class="glyphicon glyphicon-shopping-cart"></span> 工时管理</a></li>
				<li class="liClass"><a href="javascript:void(0);" target="workareaFrame"><span class="glyphicon glyphicon-send"></span> 费用管理</a></li>
