				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label for="create-customerOwner" class="col-sm-2 control-label">登记人<span style="font-size: 15px; color: red;">*</span></label>
							...
							<label for="create-customerName" class="col-sm-2 control-label">联系人<span style="font-size: 15px; color: red;">*</span></label>
							<div class="col-sm-10" style="width: 200px;">
						...
						<div class="form-group">
                            <label for="create-website" class="col-sm-2 control-label">项目名称</label>
                            <div class="col-sm-10" style="width: 200px;">
								<select class="form-control" id="create-customerOwner">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label for="edit-customerOwner" class="col-sm-2 control-label">登记人<span style="font-size: 15px; color: red;">*</span></label>
							<div class="col-sm-10" style="width: 200px;">
							...
							<label for="edit-customerName" class="col-sm-2 control-label">联系人<span style="font-size: 15px; color: red;">*</span></label>
							<div class="col-sm-10" style="width: 200px;">
						...
						<div class="form-group">
                            <label for="edit-website" class="col-sm-2 control-label">项目名称</label>
                            <div class="col-sm-10" style="width: 200px;">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="height: 80px;">
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      <div class="input-group-addon">登记人</div>
				      <input class="form-control" type="text">
				    </div>
				  </div>
